...
pause
bw -hmmdir en-us -moddeffn en-us/mdef -ts2cbfn .cont. -feat 1s_c_d_dd -lda en-us/feature_transform -agc none -cmn current -varnorm no -dictfn en-us/dict/dictionary.dic -ctlfn ILA_voice_train.listoffiles -lsnfn ILA_voice_train.transcription -accumdir .
